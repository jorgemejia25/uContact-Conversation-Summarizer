...
const service_1 = require("./modules/database/service");
const database_1 = require("./modules/database/database");
async function main() {
    try {
        ...
        if (results.length === 0) {
            ...
            results.forEach((record) => {
                console.log(`| ${record.fecha} | ${record.horas.slice(0, 35).padEnd(35)} |`);
            });
            console.log("-".repeat(60));
